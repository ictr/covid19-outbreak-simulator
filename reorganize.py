...
#adds command line functionality
import argparse
...
#functions
def createDictionary(txtfile): #converts txt file to dictionary
...
def cellFill(key): #fills in cells given dict key; exception case checking for n_outbreak_duration because it has a list of 1 element
...
# finds confidence intervals for each value
