...
| `n_no_outbreak`                       | Number of simulations with no outbreak (no symptom)                                                                                                                                     |
| `n_outbreak_duration_XXX`             | Number of simulations with outbreak ends on the `XXX` day                                                                                                                               |
...
| `n_first_infected_by_seed_on_day_XXX` | Number of simulations when the introduced carrier infect the first infectee on day `XXX`, `XXX<1` is rounded to 1, and so on.                                                           |
...
| `n_no_first_symptom`                  | Number of simulations when no one showed any symptom                                                                                                                                    |
| `n_first_symptom_on_day_XXX`          | Number of simulations when the first symptom appear at day `XXX`, `XXX < 1` is rounded to 1, and so on.                                                                                 |
| `n_no_second_symptom`                 | Number of simulations when there is a first, but no second symptom.                                                                                                                     |
| `n_second_symptom_on_day_XXX`         | Number of simulations when the second symptom appear at day `XXX` **after the first symptom**                                                                                           |
| `n_no_third_symptom`                  | Number of simulations when there is a second, but no third symtom                                                                                                                       |
