    ...
    def get_parser(self):
        ...
        parser.add_argument(
            ...
            help="""One or more types of individuals to be quarantined, can be "infected",
                "uninfected", "quarantined", "recovered", "vaccinated", "unvaccinated",
                "all" or combinations of them with & and |. Individuals will be selected based
                on conditions until --count or --proportion is satisfied""",
        )
        parser.add_argument(
